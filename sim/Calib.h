...
const int in_id = 9; //pi+,pi-,e+,e- = 8,9,3,2
const char inFile[][200] = {"/home/yoren/bnl/PHENIX/ee/AuAu/my-2M_piminus_embed_hagedorn_v2.root", //2M_piplus_embed_hagedorn_v1
