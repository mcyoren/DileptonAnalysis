...
int main(){
  ...
  pythia.readString("WeakSingleBoson:ffbar2gmZ = on"); // Drell-Yan Prduction

  pythia.readString("PhaseSpace:mHatMin = 1.0");
  ...
  for(int ievt = 0; ievt < nevt; ievt++){
    ...
    tree->Fill();
    evt_count++;
    if(evt_count%500==0) cout << evt_count << "\t" << "Completed" << endl;
    nevt++;
