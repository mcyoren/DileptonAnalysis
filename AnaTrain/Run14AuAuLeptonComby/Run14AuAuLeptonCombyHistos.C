...
Run14AuAuLeptonCombyHistos::Run14AuAuLeptonCombyHistos()
{
  ...
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V0",  "delt_phi_ee_DCA_V0",  N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V1",  "delt_phi_ee_DCA_V1",  N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V2",  "delt_phi_ee_DCA_V2",  N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V3",  "delt_phi_ee_DCA_V3",  N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V4",  "delt_phi_ee_DCA_V4",  N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V5",  "delt_phi_ee_DCA_V5",  N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V6",  "delt_phi_ee_DCA_V6",  N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V7",  "delt_phi_ee_DCA_V7",  N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V8",  "delt_phi_ee_DCA_V8",  N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V9",  "delt_phi_ee_DCA_V9",  N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V10", "delt_phi_ee_DCA_V10", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V11", "delt_phi_ee_DCA_V11", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V12", "delt_phi_ee_DCA_V12", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V13", "delt_phi_ee_DCA_V13", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V14", "delt_phi_ee_DCA_V14", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V15", "delt_phi_ee_DCA_V15", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V16", "delt_phi_ee_DCA_V16", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V17", "delt_phi_ee_DCA_V17", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V18", "delt_phi_ee_DCA_V18", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V19", "delt_phi_ee_DCA_V19", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V20", "delt_phi_ee_DCA_V20", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V21", "delt_phi_ee_DCA_V21", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V22", "delt_phi_ee_DCA_V22", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V23", "delt_phi_ee_DCA_V23", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V24", "delt_phi_ee_DCA_V24", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V25", "delt_phi_ee_DCA_V25", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V26", "delt_phi_ee_DCA_V26", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V27", "delt_phi_ee_DCA_V27", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V28", "delt_phi_ee_DCA_V28", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V29", "delt_phi_ee_DCA_V29", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V30", "delt_phi_ee_DCA_V30", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V31", "delt_phi_ee_DCA_V31", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
  Master3D.push_back(new TH3D("delt_phi_ee_DCA_V32", "delt_phi_ee_DCA_V32", N_phi_bins,   phi_bins, N_phi_bins, phi_bins,  N_pt, pt_bins));
